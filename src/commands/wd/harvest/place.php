...
QUERY;
    ...
    **/
    public static function execute($params=[]) {
        ...
        if(count($params) != 1) {
            echo "WRONG USAGE : '{$params[0]}'. This command must be called with one parameter:\n";
            echo "    'prepare' to build data/tmp/wikidata/places.csv from data/tmp/wikidata/person/\n";
            echo "    'harvest' to retrieve wikidata places in data/tmp/wikidata/place/ from data/tmp/wikidata/places.csv\n";
        }
