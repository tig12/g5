...
/******************************************************************************
    ...
    Adds one or several occu in db.
    If the occupation exists, it is overriden.
    In case of change of slug, profession groups must be recomputed.
...
class ZZZoccu implements Command {
