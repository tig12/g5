...
class Serie1955{
    ...
    // *****************************************
    /** 
        Generates the 1955 files in 4-1955-generated/
        from csv files located in 3-cura-modified-A/
    ...
    **/
    public static function modified21955($serie){
        ...
        foreach(Serie1955Data::GROUPS as $groupCode => [$groupName, $serie]){
            ...
            $res = [];
            $inputfile = Config::$data['dirs']['3-cura-modified'] . DS . $serie . '.csv'; // file generated by class SerieA
