...
/********************************************************************************
    ...
    Input data are the files contained in 5-1955-edited
    Outputs files in two directories : 9-1955-original and 9-1955-corrected
...
********************************************************************************/
namespace gauquelin5\model\g1955;
...
class Serie1955{
    ...
    **/
    ...
    // *****************************************
    /** 
        Generates the csv files in 9-1955-original/
        Uses files located in 5-1955-edited/ and files located in 2-cura-csv/
    ...
    **/
    ...
    // *****************************************
    /** 
        Generates the csv files in 9-1955-original/ from csv files located in 5-1955-edited/
        See 9-1955-original/README for a meaning of generated fields
    ...
    **/
    public static function generateOriginal($serie){
        $src_dir = Config::$data['dirs']['5-1955-edited'];
        $dest_dir = Config::$data['dirs']['9-1955-original'];
...
// end @todo externalize this code
    ...
    **/
    ...
    /** 
        ...
        - csv files located in 2-cura-csv/
        - csv files located in 3-cura-marked/
        Takes an exact copy of files in 2-cura-csv
    ...
    **/
    public static function marked2generated($serie){
        ...
        foreach(self::GROUPS_1955 as $groupCode => [$groupName, $serie]){
            ...
            $res = [];
            $inputfile = Config::$data['dirs']['2-cura-csv'] . DS . $serie . '.csv'; // file generated by class SerieA
            $input = file($inputfile);
            $N = count($input);
            $fieldnames = explode(Gauquelin5::CSV_SEP, $input[0]);
            for($i=1; $i < $N; $i++){
                $fields = explode(Gauquelin5::CSV_SEP, $input[$i]);
                $NUM = $fields[0]; // by convention, all generated csv file of 2-cura-csv have NUM as first field
            ...
            // sort $res
            //
            // here simplification : files 2-cura-csv/A1.csv and A2.csv
