...
/******************************************************************************
    ...
    An object of type TODO represents a source in g5 db.
    
    @license    GPL
    @history    2021-09-15 22:37:50+02:00, Thierry Graff : Creation
********************************************************************************/
...
class TODO {
    ...
    /**
        Structure of a source object, contained in src/model/TODO.yml
    **/
    public $data = [];
    ...
    **/
    public function __construct($yamlFile = ''){
        ...
        $this->data = yaml_parse(file_get_contents(__DIR__ . DS . 'TODO.yml'));
        if($yamlFile == ''){
    ...
    /** Creates an object of type TODO from database, using its slug. **/
    public static function getBySlug($slug): ?TODO {
