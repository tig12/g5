...
class fixGnr implements Command {
    ...
    /* 
    Add param format : smalll full
    modify csv 1083 file instead of generating an array containing corrections
    */
...
//echo "targetNUM $targetNUM - date_cura = '$date_cura'\n";
                ...
                if(count($candidates) == 0){
                    ...
                    echo "    Possible Cura $curaFilename :\n";
                ...
                if(count($candidates) > 1){
                    ...
                    echo "    Possible matches in cura $curaFilename : " . implode($candidates, ', ') . "\n";
                    continue; // next muller rec
                }
